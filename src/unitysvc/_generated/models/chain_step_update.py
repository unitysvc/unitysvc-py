...
T = TypeVar("T", bound="ChainStepUpdate")


@_attrs_define
class ChainStepUpdate:
    name: None | str | Unset = UNSET
    target_path: None | str | Unset = UNSET
    on_success: None | str | Unset = UNSET
    on_failure: None | str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        on_success: None | str | Unset
        if isinstance(self.on_success, Unset):
            on_success = UNSET
        else:
            on_success = self.on_success

        on_failure: None | str | Unset
        if isinstance(self.on_failure, Unset):
            on_failure = UNSET
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_on_success(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        on_success = _parse_on_success(d.pop("on_success", UNSET))

        def _parse_on_failure(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        on_failure = _parse_on_failure(d.pop("on_failure", UNSET))
        ...
        chain_step_update.additional_properties = d
        return chain_step_update
