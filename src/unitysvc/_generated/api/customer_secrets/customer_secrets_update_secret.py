...
def sync_detailed(
    ...
    *,
    ...
    """ Update Secret
     ...
     Rotate the value of an existing customer secret.

    The new value replaces the old one and is encrypted. The secret's
    name cannot be changed. The customer's routing cache is
    invalidated so the gateway picks up the new value immediately.
