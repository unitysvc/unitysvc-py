...
def sync_detailed(
    ...
    *,
    ...
    """List Customer Group Membership

     Return the customer's editable collections flagged with whether
    they contain this service, plus eligibility and a synthetic
    Favorites entry.
