...
def sync_detailed(
    ...
    *,
    ...
    """Add Member
     ...
     Add a subscribed service to a customer-owned collection.

    The service must be one the customer has an active enrollment for
    (the same subscription predicate the gateway uses). Collections are
    capped at ``MAX_MEMBERS_PER_COLLECTION`` members.
