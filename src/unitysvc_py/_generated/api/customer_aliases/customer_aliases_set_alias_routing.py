...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/aliases/{alias_id}/route".format(alias_id=alias_id,),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Set Alias Routing
     ...
     Make this alias the routing alias for its (name, routing_key) combo.

    Any alias currently routing the same combo is automatically demoted
    to non-routing. Use this for A/B switching between alternatives.
